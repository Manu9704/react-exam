...
function Pricing(){
    return(
        <div className="Pricing">
            <div className="first">
                <div className="name">
                    <TiLeaf className="sym"/> Lite
                </div>
                <p className="des">Perfect to get started</p>
                <div className="cost">
            ...
            <div className="second">
                <div className="name">
                    <TbRobot className="sym"/> Pro
                </div>
                <p className="des">Perfect to get started</p>
                <div className="cost">
                    <h1 className="dsym"><BiDollar/></h1>
                    <h1 className="dam">19</h1>
                    <p>per seat/month</p>
                </div>
                <button className="main">Try 7 days for free</button>
                <div className="list">
            ...
            <div className="third">
            <div className="name">
                    <BsLightningCharge className="sym"/> Ultimate
                </div>
